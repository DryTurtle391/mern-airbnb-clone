          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="absolute bottom-1 right-1 text-white bg-black p-1 rounded-2xl opacity-80"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <button
                ...
                className="absolute bottom-1 left-1 text-white bg-black p-1 rounded-2xl opacity-80"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
