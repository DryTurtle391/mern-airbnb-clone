        ...
        <div className="new-place">
          <form>
            ...
            <div className="mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
              <button className=" flex justify-center items-center gap-2 border bg-transparent text-xl rounded-2xl p-8  text-gray-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
            ...
            <div>
              ...
              <div className="grid gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <label className="border rounded-2xl flex gap-2 p-3">
                  <input type="checkbox" />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
